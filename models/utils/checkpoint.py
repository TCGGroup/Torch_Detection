...
from datasets.utils import exist_or_mkdir
...
def load_state_dict(module, state_dict, strict=False, logger=None):
    ...
    Args:
        ...
        strict (bool): whether to strictly enforce that the keys
            ...
            :meth:`~torch.nn.Module.state_dict` function. Default:
            ``False``.
...
def load_checkpoint(model,
    ...
    Args:
        ...
        strict (bool): Whether to allow different params for the model and
            checkpoint.
        logger (:mod:`logging.Logger` or None): The logger for error
        message.
    ...
    if filename.startswith('modelzoo://'):
        if 'vgg' in filename:
            ...
            raise ValueError('Only vgg and resnet are supported in modelzoo, '
                             '{} is not supported, change another way to load'
